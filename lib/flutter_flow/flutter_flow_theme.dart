...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF374151);
...
class ThemeTypography extends Typography {
  ...
  TextStyle get displayMedium => GoogleFonts.robotoMono(
        color: theme.primaryText,
  ...
  TextStyle get displaySmall => GoogleFonts.robotoMono(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 24.0,
      );
  ...
  TextStyle get headlineLarge => GoogleFonts.robotoMono(
        color: theme.primaryText,
  ...
  TextStyle get headlineMedium => GoogleFonts.robotoMono(
        color: theme.primaryText,
        fontWeight: FontWeight.normal,
        fontSize: 20.0,
      );
  ...
  TextStyle get headlineSmall => GoogleFonts.robotoMono(
        color: theme.primaryText,
        fontWeight: FontWeight.normal,
        fontSize: 18.0,
      );
