  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final profileSettingsUsersRecord = snapshot.data!;
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(24.0, 10.0, 24.0, 24.0),
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                context.goNamedAuth(LandingPageWidget.routeName,
                                    context.mounted);
                              },
                              text: 'Log out',
